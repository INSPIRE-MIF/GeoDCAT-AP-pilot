# Pilot Phase 2 - Kick-off Meeting (5 December 2025)
...
* **Working team T-1**. Support to the alignment of INSPIRE to data.europa.eu:
    ...
    * **Sub-working team T-1A**. Management of geospatial metadata harvesting and reporting issues.
      ...
      _Tasks_:
      - Identification of potential harvesting and reporting issues in the SEMIC repositories
      - Community discussion and agreement on targeted solutions in GeoDCAT-AP
    ...
    * **Sub-working g team T-1B**. Specific analysis and good practices for INSPIRE-data.europa.eu alignment.
      ...
      _Tasks_:
      - Drafting the Geospatial High-Value Datasets tagging good practice specification
      ...
      - Discussion the need to cover (selected) remaining gaps (e.g., candidates: related  to INSPIRE / HVD reporting, geospatial data filtering in data.europa.eu, analysis of specific changes needed to the TGs)
      - Inputs for / Outputs from T-1A working team
